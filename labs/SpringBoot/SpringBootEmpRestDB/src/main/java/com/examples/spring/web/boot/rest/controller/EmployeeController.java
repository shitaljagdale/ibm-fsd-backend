package com.examples.spring.web.boot.rest.controller;
...
import com.examples.spring.web.boot.rest.exception.LoginException;
import com.examples.spring.web.boot.rest.exception.ValidationException;
import com.examples.spring.web.boot.rest.model.Employee;
import com.examples.spring.web.boot.rest.model.ErrorDetails;
import com.examples.spring.web.boot.rest.service.EmployeeService;
...
public class EmployeeController {
	...
	public HttpEntity<? extends Object> addEmployee(@RequestBody Employee employee, WebRequest request,
		...
		Integer empId = empService.add(employee);
...
//		return ResponseEntity.ok().cacheControl(CacheControl.maxAge(10, TimeUnit.MINUTES).cachePrivate()).body(empService.list());
	...
	@CrossOrigin(origins = "http://localhost:4200")
	@GetMapping("/{id}")
	public HttpEntity<Employee> getEmployee(@PathVariable int id, HttpSession session) {
	...
	@CrossOrigin(origins = "*")
	@PutMapping("/{id}")
	public HttpEntity<? extends Object> updateEmployee(@RequestBody Employee employee, @PathVariable Integer id,
...
//		return new ResponseEntity<Employee>(employee, HttpStatus.OK);
	...
	@CrossOrigin(origins = "*")
	@DeleteMapping("/{id}")
	public HttpEntity<String> deleteEmployee(@PathVariable int id, HttpSession session) {
